...
class GetAnnouncementUseCase @Inject constructor(
    ...
    override suspend fun buildRequest(params: Int?): Flow<Resource<PagingData<AnnouncementModel>>> {
        return repository.getCompanyAnnouncements(params ?: 0).flowOn(dispatcher)
    }
}