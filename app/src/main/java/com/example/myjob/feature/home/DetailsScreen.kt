...
@Composable
fun DetailsScreen(navController: NavController, homeViewModel: HomeViewModel = hiltViewModel()) {

    val interactionSource = remember { MutableInteractionSource() }

    Detail(navController, interactionSource, homeViewModel)
...
fun PreviewDetail() {
    ...
    DetailPreview(interactionSource, homeViewModel)
}