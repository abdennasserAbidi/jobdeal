...
fun DetailInvitationScreen(
    ...
    invitationDetailViewModel.getInvitationDetail(idInvitation.toInt())
                ...
                Column(
                    ...
                    Row(
                        ...
                        Surface(
                            ...
                            val nickname = userName.trim().ifEmpty { "Test Test" }.split(" ").map { it.first() }.joinToString("")
                            Box(
                                contentAlignment = Alignment.Center
                            ) {
                                Text(
